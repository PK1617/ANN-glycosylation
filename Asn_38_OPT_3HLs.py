...
for i in range(1, 2):#max_nodes+1):
    print (i)
    for j in range(1, 2):#max_nodes+1):
        for k in range(1, 2):#max_nodes+1):
            ...
            [0,	0.017,	0.029,	0.175,	0.17,	0.171,	0.089,	0.086,	0.081,	0.289,	0.246,	0.27],
